...
BUILD_DATE=$(date)
BUILD_FLAGS=(-ldflags="-w -X github.com/kubeless/kubeless/pkg/version.Version=${GIT_COMMIT} -X github.com/kubeless/kafka-trigger/pkg/event-consumers/kafka.UserAgent=kafka-trigger-controller-${GIT_COMMIT}")
